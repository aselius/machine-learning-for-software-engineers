# 탑-다운 공법을 이용한 학습 가이드라인: 소프트웨어 엔지니어를 위한 기계학습 가이드라인
...
본 문서는 [Google Interview University]에서 영감을 받아 작성되었습니다. (https://github.com/jwasham/google-interview-university).
